...
#define PATH "/home/komal/workspace/ros/ros_opencv/catkin_ws/src/outcpp.avi"

// Define the codec and create VideoWriter object.The output is stored in 'outcpp.avi' file.
VideoWriter video(PATH, cv::VideoWriter::fourcc('M','J','P','G'), 10, Size(640,480));
...
int main(int argc, char **argv)
{
  ...
  image_transport::Subscriber sub = it.subscribe("camera", 1, recordCallback);
